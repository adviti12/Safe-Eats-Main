      ...
      <Card className="w-full max-w-md border-none shadow-xl bg-white/80 backdrop-blur-sm relative z-10">
        ...
        <CardContent className="pb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="emergencyContact" className="text-sm font-medium">Emergency Contact Phone</Label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              ...
              <p className="text-xs text-gray-500 mt-1">Phone number for emergency notifications</p>
            </div>
